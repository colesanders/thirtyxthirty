...
@Component({
  selector: 'thirty-water-fountain-mdv',
  templateUrl: './water-fountain-mdv.component.html',
  styleUrls: ['./water-fountain-mdv.component.scss']
})
export class WaterFountainMDVComponent implements OnInit {
